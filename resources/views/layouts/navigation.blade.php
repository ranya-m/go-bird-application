<nav x-data="{ open: false }" class="bg-white border-b border-neutral-100">
        ...
        <div class="flex h-16">
               ...
               <div class="hidden sm:flex sm:items-center sm:ml-6 ">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm 2xl:text-base  leading-4 font-medium rounded-md text-neutral-500 bg-white hover:text-neutral-700 focus:outline-none transition ease-in-out duration-150">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-neutral-200">
            <div class="px-4">
                @auth
                <div class="font-medium text-sm 2xl:text-base text-neutral-800">{{ Auth::user()->name }}</div>
                <div class="font-medium text-sm 2xl:text-base text-neutral-500">{{ Auth::user()->email }}</div>
                @else
                {{__('Account')}}
                @endauth
            </div>
