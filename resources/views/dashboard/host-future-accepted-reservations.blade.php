    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                <h2 class="font-semibold text-2xl text-neutral-800 leading-tight py-4">Future Accepted Stays</h2>
                @foreach ($futureAcceptedReservations as $reservation)
