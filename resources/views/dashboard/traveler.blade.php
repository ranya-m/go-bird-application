<x-app-layout>
    ...
    <div class="mx-5 mt-5  bg-white shadow sm:rounded-lg">
        ...
        <h2 class="font-semibold text-2xl text-gray-800 leading-tight p-4">My Confirmed Stays</h2>
        <x-primary-button>
            <a href="{{ route('traveler.confirmed-stays') }}">Check Confirmed Stays</a>
        </x-primary-button>

        <h2 class="font-semibold text-2xl text-gray-800 leading-tight p-4">My Past Stays</h2>
        <x-primary-button>
